...
# Store versions externally to share between installer and uninstaller
. $PSScriptRoot\Version.ps1

$packageName = 'continuum_miniconda3' # arbitrary name for the package, used in messages
$toolsDir = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url = "https://repo.continuum.io/miniconda/Miniconda3-$version-Windows-x86.exe" # download url
$url64 = "https://repo.continuum.io/miniconda/Miniconda3-$version-Windows-x86_64.exe" # 64bit URL here or remove - if installer is both, use $url
...
$packageArgs = @{
  ...
  # optional
  registryUninstallerKey = 'Python $py_ver (Miniconda3 $version 64-bit)' #ensure this is the value in the registry
